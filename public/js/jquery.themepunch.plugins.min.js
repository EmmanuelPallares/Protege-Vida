            ...
            for (var r = 0; i.length > r; r++)
              for (var o in e)
                e.hasOwnProperty(o) &&
                  ...
                  i[r] &&
                    (n =
                      i[r] + n.substring(0, 1).toUpperCase() + n.substring(1)),
                  (t.style[n] = e[o]));
            "none" == e.userSelect &&
...
(function (t) {
  ...
  if (!e.TweenLite) {
          ...
          if (0 === d && r)
            for (
              _ = ("com.greensock." + i).split("."),
                u = _.pop(),
                m = o(_.join("."))[u] = this.gsClass = r.apply(r, a),
                n &&
                  ((e[u] = m),
    ...
    var v = [0, 0, 1, 1],
      ...
      P = (T.register = function (t, e, i, s) {
        for (
          ...
          for (
            n = h[_],
              r = s ? d("easing." + n, null, !0) : l.easing[n] || {},
              a = u.length;
            --a > -1;
    ...
    var D = d(
        ...
        function (e, i, s) {
          if (
            (x.call(this, i, s), (this.render = D.prototype.render), null == e)
          )
                ...
                n
                  ? "string" != typeof n
                    ? n.length &&
                      ...
                      : ((this._siblings[r] = B(n, this, !1)),
                        1 === l &&
                          this._siblings[r].length > 1 &&
                          q(n, this, null, 1, this._siblings[r]))
                    : ((n = a[r--] = D.selector(n)),
        ...
        if (t >= l)
          (this._totalTime = this._time = l),
            ...
            0 === l &&
              ...
              (this._rawPrevTime = a = !e || t || 0 === a ? t : h));
        else if (1e-7 > t)
          ...
          (1 === u || (3 === u && _ >= 0.5)) && (_ = 1 - _),
            ...
            1 === m
              ...
              : 4 === m && (_ *= _ * _ * _ * _),
            (this.ratio =
              1 === u ? 1 - _ : 2 === u ? _ : 0.5 > t / l ? _ / 2 : 1 - _ / 2);
          ...
          if (
            (t >= _
              ? ((this._totalTime = this._time = _),
                ...
                (this._rawPrevTime =
                  this._duration || !e || t || 0 === this._rawPrevTime ? t : r),
                (t = _ + 1e-4))
              : 1e-7 > t
              ? ((this._totalTime = this._time = 0),
                (0 !== u ||
    ...
    function (t, e) {
      ...
      var h,
          ...
          return (
            ...
            "%" === r && -1 !== e.indexOf("border")
              ...
              : ((l.cssText =
                  ...
                  ";line-height:0;"),
                "%" !== r && o.appendChild
                  ? (l[a ? "borderLeftWidth" : "borderTopWidth"] = i + r)
                  : ((o = t.parentNode || X.body),
                    (l[a ? "width" : "height"] = i + r)),
                o.appendChild(I),
                (n = parseFloat(I[a ? "offsetWidth" : "offsetHeight"])),
                o.removeChild(I),
                0 !== n || s || (n = Q(t, e, i, r, !0))),
            h ? -n : n
          );
        ...
        G = function (t, e, i, r, s) {
          ...
          if (r) for (a in r) "class" !== a && (l[a] = r[a]);
          ...
          if (16 === n.length) {
            ...
            if (
              ...
              (v.rotationX = G * L),
                ...
                (v.scaleZ = (0 | (Math.sqrt(Q * Q + k * k) * x + 0.5)) / x),
                (v.skewX = 0),
                (v.perspective = $ ? 1 / (0 > $ ? -$ : $) : 0),
                (v.x = C),
                (v.y = O),
            ...
            (v.x = n[4] || 0),
              ...
              (f = ie || re ? Math.atan2(ie, re) * L + p : v.skewX || 0),
        ...
        Se = function () {
          ...
          if (R || P.skewX)
            (v = Math.cos(R)),
              ...
              (s = y),
              P.skewX &&
                ((R -= P.skewX * M), (v = Math.cos(R)), (y = Math.sin(R))),
              (e = -y),
              (n = v);
          else {
          ...
          parser: function (t, e, i, r, n, a, o) {
            ...
            if ("string" == typeof y.transform && ye)
              ...
              (l.rotation = se(
                ...
                (l.skewX = null == y.skewX ? d.skewX : se(y.skewX, d.skewX)),
                (l.skewY = null == y.skewY ? d.skewY : se(y.skewY, d.skewY)),
                (h = l.skewY - d.skewY) && ((l.skewX += h), (l.rotation += h));
            }
            for (
              we && null != y.force3D && ((d.force3D = y.force3D), (f = !0)),
                p =
                  d.force3D ||
                  d.z ||
                  d.rotationX ||
              ...
              (_ || (we && p && d.zOrigin)) &&
                (ye
                  ? ((f = !0),
                    (i = xe),
                    (_ = (_ || H(t, i, s, !1, "50% 50%")) + ""),
                    (n = new pe(m, i, 0, 0, n, -1, "transformOrigin")),
                    (n.b = m[i]),
                    (n.plugin = a),
                    we
                      ? ((u = d.zOrigin),
                      ...
                      : (n.xs0 = n.e = m[i] = _))
                  : ee(_ + "", d)),
              f && (r._transformType = p || 3 === this._transformType ? 3 : 2),
              n
            );
          },
          prefix: !0,
              ...
              this.p.indexOf("border") && (b[l] = V(b[l])),
                ...
                g !== v &&
                  ...
                  "%" === g
                    ...
                    : ((_ = T + "px"), (u = x + "px")),
                  y &&
                    ((p = parseFloat(_) + c + g), (h = parseFloat(u) + c + g))),
      ...
      var Ce = function (t, e) {
        ...
        Ae = function (t) {
          if (((this.t._gsClassPT = this), 1 === t || 0 === t)) {
            this.t.class = 0 === t ? this.b : this.e;
            for (var e = this.data, i = this.t.style; e; )
              e.v ? (i[e.p] = e.v) : Ce(i, e.p), (e = e._next);
            1 === t && this.t._gsClassPT === this && (this.t._gsClassPT = null);
          } else this.t.class !== this.e && (this.t.class = this.e);
        };
      me("class", {
        parser: function (t, e, r, n, a, o, l) {
          var h,
            ...
            d = t.style.cssText;
          if (
            ((a = n._classPT = new pe(t, r, 0, 0, a, 2)),
            (a.setRatio = Ae),
            (a.pr = -11),
            (i = !0),
            (a.b = c),
      ...
      (l = a.prototype),
        ...
        (l._onInitTween = function (t, e, o) {
          ...
          if (
            ...
            "string" == typeof e &&
              ...
              (w.cssText = d + ";" + e),
              (l = G(t, l, $(t)).difs),
              !z && x.test(e) && (l.opacity = parseFloat(RegExp.$1)),
              (e = l),
              (w.cssText = d)),
                    ...
                    ? ((u = parseFloat(p)),
                      ...
                      g
                        ? ((_ = parseInt(f.charAt(0) + "1", 10)),
                          ...
                          (d = f.replace(y, "")))
                        : ((_ = parseFloat(f)),
                          (d = m ? f.substr((_ + "").length) || "" : "")),
                      "" === d && (d = a in r ? r[a] : c),
                      (f = _ || 0 === _ ? (g ? _ + u : _) + d : e[a]),
                      c !== d &&
                        "" !== d &&
                        (_ || 0 === _) &&
                        (u || 0 === u) &&
        ...
        (l._enableTransforms = function (t) {
          (this._transformType = t || 3 === this._transformType ? 3 : 2),
            (this._transform = this._transform || be(this._target, s, !0));
        }),
