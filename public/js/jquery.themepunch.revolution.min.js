...
(function (e, t) {
  function n(n, i) {
    ...
    if (
      i.forceFullWidth == "on" &&
      n.closest(".forcefullwidth_wrapper_tp_banner").length == 0
    ) {
    ...
    if (!n.hasClass("revslider-initialised")) {
          ...
          if (e(this).attr("src").indexOf("vim") > 0 && E == 0) {
            ...
            e("head")
              ...
              .each(function () {
                if (
                  e(this).attr("src") ==
                  x + "://a.vimeocdn.com/js/froogaloop2.min.js"
                )
                  i = false;
              });
      ...
      if (i.shuffle == "on") {
        for (var N = 0; N < n.find(">ul:first-child >li").length; N++) {
          var C = Math.round(
            Math.random() * n.find(">ul:first-child >li").length
          );
          n.find(">ul:first-child >li:eq(" + C + ")").prependTo(
            n.find(">ul:first-child")
          );
        }
      }
      i.slots = 4;
    ...
    if (!a.hasClass("preview4")) {
      ...
      TweenLite.to(h, 0.5, {
        ...
        onComplete: function () {
          ...
          TweenLite.to(h, 0.5, { autoAlpha: 1, delay: 0.2 });
        },
      });
    } else {
    ...
    if (f.hasClass("preview4") && !f.hasClass("hashoveralready")) {
      ...
      f.hover(
        function () {
          ...
          TweenLite.to(n, 0.2, { autoAlpha: 1, overwrite: "all" });
        },
        function () {
          var t = e(this).find(".tp-arr-iwrapper");
          var n = e(this).find(".tp-arr-allwrapper");
          ...
          TweenLite.to(n, 0.2, { delay: 0.6, autoAlpha: 0, overwrite: "all" });
        }
      );
      l.hover(
        function () {
  ...
  var C = function (n, r) {
    ...
    n.find(">li").each(function () {
      ...
      if (t.index != r.act && t.index != r.next)
        TweenLite.set(t, { zIndex: 16 });
    });
    if (r.firststart == 1) TweenLite.set(i, { autoAlpha: 0 });
    TweenLite.set(i, { zIndex: 18 });
    TweenLite.set(o, { opacity: 0, zIndex: 20 });
    var f = 0;
  ...
  var k = function (n, r, i, s, u, a) {
    ...
    if (f == 12 || f == 13 || f == 14 || f == 15) {
      ...
      if (p == 3) {
        ...
        i.css({ position: "absolute", "z-index": 15 });
        z = T / 1200;
      }
      if (p == 4 || p == 5) I = 0.6;
      if (p == 6) I = 1.4;
      ...
      TweenLite.fromTo(
        P,
        z,
        { left: H, top: j, scale: q, opacity: F, rotation: r.rotate },
        {
          opacity: 1,
          rotation: 0,
          left: 0,
    ...
    if (f == 16) {
      ...
      TweenLite.fromTo(
        ...
        { scale: Z, rotation: $, y: 0 - D - D / 4, ease: Power2.easeInOut }
      );
      setTimeout(function () {
      ...
      TweenLite.fromTo(
        ...
        { scale: tt, rotation: J, y: D + D / 4, ease: Power2.easeInOut }
      );
      TweenLite.fromTo(
        s.find(".tp-half-two"),
        T / 2e3,
    ...
    if (f == 19 || f == 22) {
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.to(o, 0.1, { opacity: 1, delay: (t * 50) / 1e3 + T / 3e3 });
      });
      u.find(".slotslide").each(function (t) {
        var o = e(this);
        var f = -90;
    ...
    if (f == 20) {
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.to(o, 0.1, { opacity: 1, delay: (t * 50) / 1e3 + T / 2e3 });
      });
      u.find(".slotslide").each(function (t) {
        var o = e(this);
        if (x != 1) {
    ...
    if (f == 21 || f == 25) {
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.to(o, 0.3, {
          opacity: 1,
          delay: (t * 100) / 1e3 + (T * 0.2) / 2e3 + T / 1e4,
        });
      });
      if (x != 1) {
        var ot = -r.width;
    ...
    u.each(function (n) {
      ...
      if (f.hasClass("tp-static-layer")) {
        if (!f.hasClass("tp-is-shown")) {
          if (
            (f.data("startslide") <= r.next && f.data("endslide") >= r.next) ||
            f.data("startslide") == r.next ||
            f.data("endslide") == r.next
          ) {
      ...
      if (h == 0) {
        ...
        TweenLite.set(f, { top: K, left: J, overwrite: "auto" });
        if (a == 0) u = true;
        if (!u) {
          ...
          var Y = new TimelineLite({ smoothChildTiming: true, onStart: G });
          if (r.fullScreenAlignForce == "on") {
          }
          var Z = f;
    ...
    n.find(".rs-pendulum").each(function () {
      ...
      if (n.data("timeline") == t) {
        ...
        (speed = n.data("speed") == t ? 2 : n.data("speed")),
          ...
          (easing = n.data("ease") == t ? Power2.easeInOut : n.data("ease"));
        i = i * r;
        s = s * r;
        n.data("timeline").append(
          new TweenLite.fromTo(
            n,
            speed,
            { rotation: i, transformOrigin: origin },
        ...
        n.data("timeline").append(
          new TweenLite.fromTo(
            n,
            speed,
            { rotation: s, transformOrigin: origin },
            {
              rotation: i,
              ease: easing,
              onComplete: function () {
  ...
  var Y = function (n, r) {
    ...
    n.find(".defaultimg").each(function () {
      ...
      if (
        ...
        TweenLite.set(n.data("kenburn img"), { autoAlpha: 0 });
    });
  };
  var Z = function (t, n) {
      ...
      t.on("mousemove.hoverdir, mouseleave.hoverdir", function (n) {
        ...
        switch (n.type) {
          ...
          case "mouseleave":
            r.find(".tp-parallax-container").each(function () {
              var t = e(this);
              TweenLite.to(t, 1.5, { x: 0, y: 0, ease: Power3.easeOut });
            });
            break;
        }
      });
        ...
        window.ondeviceorientation = function (n) {
          ...
          s.find(".tp-parallax-container").each(function () {
            var t = e(this),
              ...
              r = u * n,
              i = a * n;
            TweenLite.to(t, 0.2, { x: r, y: i, ease: Power3.easeOut });
          });
        };
    }
    if (
  ...
  var et = function (t, n) {
    ...
    t.find(".tp-parallax-container").each(function (t) {
      ...
      TweenLite.to(n, 0.2, { y: i, ease: Power3.easeOut });
    });
    if (n.parallaxBgFreeze != "on") {
      var l = n.parallaxLevels[0] / 100,
        c = a * l;
      TweenLite.to(t, 0.2, { y: c, ease: Power3.easeOut });
    }
  };
  var tt = function (n, r) {
    var i = n.parent();
